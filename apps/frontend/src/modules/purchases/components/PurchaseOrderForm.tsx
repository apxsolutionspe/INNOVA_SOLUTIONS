...
export function PurchaseOrderForm({ onSubmit, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-slate-950/50 p-4">
      <motion.form initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} onSubmit={handleSubmit} className="max-h-[92vh] w-full max-w-5xl overflow-y-auto rounded-lg bg-white p-6 shadow-xl">
        ...
        <button disabled={isSaving || !items.length} type="submit" className="mt-5 h-11 w-full rounded-lg bg-brand-blue text-sm font-bold text-white disabled:opacity-60">
