    ...
    <article className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-3 break-words text-[clamp(1.25rem,2vw,1.65rem)] font-black leading-tight tracking-tight text-slate-950">
            {value}
          </p>
        </div>
      ...
      <p className="mt-4 min-h-5 text-xs font-semibold leading-relaxed text-slate-500">{description}</p>
    </article>
  );
}
