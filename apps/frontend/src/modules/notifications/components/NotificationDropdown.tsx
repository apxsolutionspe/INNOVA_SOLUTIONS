...
export function NotificationDropdown({ items, onRead, onReadAll }: { items: Notification[]; onRead: (id: string) => void; onReadAll: () => void }) {
  return (
    <div className="absolute right-0 top-14 z-50 w-80 overflow-hidden rounded-2xl border border-slate-200/90 bg-white/95 shadow-2xl shadow-slate-950/10 backdrop-blur-xl">
