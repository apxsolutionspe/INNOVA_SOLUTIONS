  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-slate-950/50 p-4">
      <div className="w-full max-w-lg rounded-lg bg-white p-6 shadow-xl">
        ...
        <p className="mt-2 text-sm text-slate-500">Las credenciales privadas se configuran solo en backend mediante variables de entorno. Aquí solo se muestran valores públicos o enmascarados.</p>
